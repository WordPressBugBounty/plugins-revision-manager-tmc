<?php
namespace shellpress\v1_4_1\lib\KLogger;

use DateTime;
use RuntimeException;
use shellpress\v1_4_1\lib\Psr\Log\AbstractLogger;
use shellpress\v1_4_1\lib\Psr\Log\LogLevel;
 ...
 *
 * Usage:
 * $log = new Katzgrau\KLogHandler\LogHandler('/var/log/', Psr\Log\LogLevel::INFO);
