...
$checkPHP   = $requirementChecker->checkPHPVersion( '7.1', 'Revision manager TMC requires PHP version >= 7.1' );
$checkWP    = $requirementChecker->checkWPVersion( '6', 'Revision manager TMC requires WP version >= 6' );
...
App::initShellPress( __FILE__, 'rm_tmc', '2.8.22', 'plugin' );
