...
= 2.8.24 =
Refactor: Wordpress 6.9.4 compatibility check.

= 2.8.23 =
Refactor: Speed up initial load of plugin.
...
= 2.8.19 =
Refactor: Wordpress 6.6.1 compatibility check.
Refactor: PHP requirement bump up to 7.1
Fix: <script> tags stripped when publishing future revisions.
