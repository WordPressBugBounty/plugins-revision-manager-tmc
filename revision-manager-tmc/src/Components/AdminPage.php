...
//				wp_enqueue_script( 'vue3', 'https://unpkg.com/vue@next', array(), $this::s()->getFullPluginVersion(), true );
                ...
                wp_add_inline_script( 'rm_tmc_AdminPageOptions', sprintf( 'const rm_tmc_settings = %1$s;', wp_json_encode( $this->s()->options->get() ) ), 'before' );
                wp_add_inline_script( 'rm_tmc_AdminPageOptions', sprintf( 'const rm_tmc_fieldsData = %1$s;', wp_json_encode( $this->getFieldsData() ) ), 'before' );
